    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update Staff Loss</h5>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <form id="expense_form" action="{{route('advances.update')}}" method="post">
                        @csrf()
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div style="border: 2px solid white; border-radius: 6px;">
                                        <input type="text" id="date1" name="date" class="form-control"
                                            required>
                                    </div>
                                </div>
                            </div>
