...
<li class="breadcrumb-item"><a href="#"> Lodge / Expenses</a></li>
@endsection
...
<div class="col-sm-12">
    <div class="card">
        <div class="card-body">
            <form id="expense_form" action="{{route('lodge-expense.search')}}" method="GET">
                @csrf()
...
@include("lodge.expense.create")
@include("lodge.expense.edit")
