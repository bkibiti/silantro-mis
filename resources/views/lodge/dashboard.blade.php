                    ...
                    <div class="card statistial-visit">
                        ...
                        <div class="card-block">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <label
                                        class="label theme-bg2 text-white f-14 f-w-400 float-right">{{ number_format($BeforeLastMonth['sales'], 2) }}</label>
                                </div>
                            </div>
                            <div class="media">
                                <div class="photo-table">
                                ...
                                <div class="media-body">
                                    <label
                                        class="label bg-c-blue text-white f-14 f-w-400 float-right">{{ number_format($BeforeLastMonth['expense'], 2) }}</label>
                                </div>
                            </div>
                            <div class="media">
                                <div class="photo-table">
                                ...
                                <div class="media-body">
                                    <label
                                        class="label bg-c-green text-white f-14 f-w-400 float-right">{{ number_format($BeforeLastMonth['profit'], 2) }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    document.title = title.concat(" | Dashboard");
</script>
