...
$(document).ready(function() {
   ...
   $(".js-my-date");
    ...
    //[Sales Search] Start
    $('.sales_searchable').multiSelect({
        selectableHeader: "<label><b>Available Products:</b></label><input type='text' class='form-control' autocomplete='off' placeholder='Search Item'>",
        selectionHeader: "<label><b>Selected Products:</b></label><input type='text' class='form-control' autocomplete='off' placeholder='Search Item'>",
        afterInit: function(ms) {
            var that = this,
                $selectableSearch = that.$selectableUl.prev(),
                $selectionSearch = that.$selectionUl.prev(),
